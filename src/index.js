...
class ShoppingCart extends React.Component {
  ...
  checkout() {
    let subtotal = this.state.headband * 27.92;
    subtotal += this.state.stovetop * 27.92;
      ...
      <div className='cart'>
        <div className='items'>
          ...
          <div className='item'>
            ...
            <div className='half'>
              Stove Top Turkey Dinner
            </div>
            <div className='half'>
              <span className='circle' onClick={this.removeStovetop}>-</span>
              <span className='pad-left pad-right'>{this.state.stovetop}</span>
              <span className='circle' onClick={this.addStovetop}>+</span>
              <strong className='right'>$27.92</strong>
            </div>
            <hr />
            <div>
